...
var runGame = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, game(10)];
            case 1:
                _a.sent();
                if (!(roundsWon.first == true)) return [3 /*break*/, 3];
                return [4 /*yield*/, game(20)];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
...
var game = function (maxLimit) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, inquirer.prompt([
                    ...
                    var randNum = Math.ceil(Math.random() * maxLimit);
